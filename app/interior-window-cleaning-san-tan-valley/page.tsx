...
export const metadata: Metadata = {
  title: 'Interior Window Cleaning in San Tan Valley, AZ | $100 OFF | Arizona window cleaning Pros',
  description: 'Professional interior window cleaning in San Tan Valley, Arizona. $100 off first service. Licensed, insured, streak-free guarantee. Call (928) 235-5934 for free estimate.',
  alternates: {
