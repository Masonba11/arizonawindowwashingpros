...
export const metadata: Metadata = {
  title: 'Interior Window Cleaning in Tempe, AZ | $100 OFF | Arizona window cleaning Pros',
  description: 'Professional interior window cleaning in Tempe, Arizona. $100 off first service. Licensed, insured, streak-free guarantee. Call (928) 235-5934 for free estimate.',
  alternates: {
