...
export const metadata: Metadata = {
  title: 'Screen Cleaning in Tempe, AZ | $100 OFF | Arizona Window Washing Pros',
  description: 'Professional screen cleaning in Tempe, Arizona. $100 off first service. Licensed, insured, streak-free guarantee. Call (480) 737-0850 for free estimate.',
  alternates: {
