...
export const metadata: Metadata = {
  title: 'Track & Sill Cleaning in Scottsdale, AZ | $100 OFF | Arizona window cleaning Pros',
  description: 'Professional track and sill cleaning in Scottsdale, Arizona. $100 off first service. Licensed, insured, streak-free guarantee. Call (928) 235-5934 for free estimate.',
  alternates: {
