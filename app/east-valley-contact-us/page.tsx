...
export const metadata: Metadata = {
  ...
  description:
    'Contact Arizona Window Cleaning Pros for East Valley window cleaning. Call (928) 235-5934 or request a free quote online. Serving Mesa, Gilbert, Chandler, Scottsdale, Tempe, Queen Creek, and San Tan Valley.',
  alternates: {
...
const faqs = [
  {
    ...
    answer:
      'You can call us at (928) 235-5934 or fill out the quote form on this page. We respond quickly and can schedule service throughout the East Valley.',
  },
  {
