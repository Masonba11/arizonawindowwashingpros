...
export const metadata: Metadata = {
  title: 'Screen Cleaning in Queen Creek, AZ | $100 OFF | Arizona window cleaning Pros',
  description: 'Professional screen cleaning in Queen Creek, Arizona. $100 off first service. Licensed, insured, streak-free guarantee. Call (928) 235-5934 for free estimate.',
  alternates: {
