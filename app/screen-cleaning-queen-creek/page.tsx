...
export const metadata: Metadata = {
  ...
  description: 'Professional screen cleaning in Queen Creek, Arizona. $100 off first service. Licensed, insured, streak-free guarantee. Call (480) 476-3731 for free estimate.',
  alternates: {
