...
export const metadata = generateMetadata({
  ...
  path: '/scottsdale-window-washing',
})
...
export default function ScottsdaleWindowWashingPage() {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'Scottsdale Window Washing', url: 'https://arizonawindowwashingpros.com/scottsdale-window-washing' },
  ])
        ...
        <div className="container-custom max-w-5xl">
          <div className="content-section">
            ...
            <div className="space-y-6">
              ...
              <p className="text-gray-700 leading-relaxed text-lg">
                Whether you live in Old Town Scottsdale, North Scottsdale, South Scottsdale, or any of the surrounding neighborhoods, we understand the unique window cleaning challenges in your area. Our team uses proven techniques and professional-grade equipment specifically suited for Scottsdale&apos;s climate conditions.
              </p>
