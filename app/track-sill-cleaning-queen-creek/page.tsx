...
export const metadata: Metadata = {
  ...
  description: 'Professional track and sill cleaning in Queen Creek, Arizona. $100 off first service. Licensed, insured, streak-free guarantee. Call (928) 235-5934 for free estimate.',
  alternates: {
