...
export const metadata: Metadata = {
  ...
  description: 'Professional window cleaning throughout the East Valley, AZ. Serving Mesa, Gilbert, Chandler, Scottsdale, Tempe, Queen Creek & San Tan Valley. 20% off first service. Licensed, insured, streak-free guarantee. Call (928) 235-5934 for free estimate.',
  alternates: {
...
const faqs = [
  ...
  },
  {
    ...
    answer: 'We offer same-day estimates and can often schedule service within 24-48 hours throughout the East Valley. Call us at (928) 235-5934 for fastest scheduling.',
  },
  {
