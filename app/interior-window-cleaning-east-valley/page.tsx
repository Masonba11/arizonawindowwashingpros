...
export const metadata: Metadata = {
  ...
  description: 'Professional interior window cleaning throughout the East Valley, Arizona. Serving Mesa, Gilbert, Chandler, Scottsdale, Tempe, Queen Creek & San Tan Valley. 20% off first service. Licensed, insured, streak-free guarantee. Call (928) 235-5934 for free estimate.',
  alternates: {
