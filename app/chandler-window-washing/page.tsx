...
export const metadata: Metadata = {
  ...
  description: 'Professional window cleaning in Chandler, AZ. $100 off first service. Licensed, insured, streak-free guarantee. Call (480) 476-3731 for free estimate.',
  alternates: {
