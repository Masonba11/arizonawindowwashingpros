...
export const metadata: Metadata = {
  ...
  description: 'Professional window cleaning in Queen Creek, AZ. $100 off first service. Licensed, insured, streak-free guarantee. Call (928) 235-5934 for free estimate.',
  alternates: {
