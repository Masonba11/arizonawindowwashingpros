...
export const metadata = generateMetadata({
  title: 'About Us',
  description: `Learn about ${BUSINESS_INFO.name} - founded in 2026 by Mason Ball, Chansyn Mapa, and Dane Howard. Three friends who built a window cleaning business on discipline, reliability, and genuine care for Arizona homeowners.`,
  path: '/about',
})
...
export default function AboutPage() {
  return (
    <>
      {/* Hero */}
      <HeroVideo
        title="About Arizona window cleaning Pros"
      ...
      <section className="section-padding gradient-bg">
        <div className="container-custom max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
            ...
            <p className="leading-relaxed">
              That mindset translates directly to how we approach every window cleaning job. We show up on time. We communicate clearly. We do the job right, without cutting corners.
            </p>
            <p className="leading-relaxed">
      ...
      {/* Why Arizona window cleaning Pros Exists */}
      <section className="section-padding gradient-bg">
        <div className="container-custom max-w-4xl">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-900">Why Arizona window cleaning Pros Exists</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-primary-500 to-primary-600 mx-auto rounded-full"></div>
          </div>
          <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
            <p className="leading-relaxed">
            ...
            <p className="leading-relaxed">
              Everything we do is built on trust, not shortcuts. When you choose Arizona window cleaning Pros, you're choosing people who genuinely care about the work and the community they serve.
            </p>
            <p className="leading-relaxed">
