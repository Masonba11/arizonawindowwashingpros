...
export const metadata: Metadata = {
  ...
  description: 'Professional exterior window cleaning in Chandler, Arizona. $100 off first service. Licensed, insured, streak-free guarantee. Call (480) 476-3731 for free estimate.',
  alternates: {
