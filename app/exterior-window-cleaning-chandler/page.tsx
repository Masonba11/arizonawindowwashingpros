...
export const metadata: Metadata = {
  title: 'Exterior Window Cleaning in Chandler, AZ | $100 OFF | Arizona window cleaning Pros',
  description: 'Professional exterior window cleaning in Chandler, Arizona. $100 off first service. Licensed, insured, streak-free guarantee. Call (928) 235-5934 for free estimate.',
  alternates: {
