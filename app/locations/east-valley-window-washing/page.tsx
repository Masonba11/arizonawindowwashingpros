...
export default function EastValleyWindowWashingPage() {
  ...
  return (
    <>
      ...
      <LocationWhyChooseUs
        idPrefix="east-valley-window-washing"
        sectionHeading="Why Choose Us for East Valley window cleaning?"
        cityPossessive="East Valley's"
        cityName="East Valley"
        experiencePhrase="working throughout East Valley"
        neighborhoodsSnippet="Mesa, Gilbert, Chandler, Tempe, Queen Creek, and surrounding communities"
      />
