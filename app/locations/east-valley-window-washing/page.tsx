...
export const metadata = generateMetadata({
  ...
  description: 'Professional exterior and interior window cleaning services in East Valley, Arizona. Expert window cleaning and screen cleaning. Starting at $150 for 1-story homes. Free quotes available.',
  path: '/locations/east-valley-window-washing',
})

const faqs = [
  {
    question: 'How much does exterior window cleaning cost in East Valley?',
    answer: 'Exterior window cleaning prices in East Valley start at $150 for 1-story homes and $180 for 2-story homes. Most East Valley homes range from $150-$350. Pricing is based on number of windows and home height. Contact us for a free estimate.',
  },
  {
    question: 'How often should I have my windows cleaned in East Valley?',
    answer: 'Given East Valley\'s desert climate with dust storms and intense sun, we recommend window cleaning every 3-4 months to maintain optimal clarity and prevent hard water spot buildup.',
  },
  {
    question: 'Do you clean both interior and exterior windows in East Valley?',
    answer: 'Yes, we offer both interior and exterior window cleaning services in East Valley. You can choose one or both depending on your needs.',
  },
  {
    question: 'What areas of East Valley do you serve?',
    answer: 'We serve all areas of East Valley, Arizona, including Mesa, Gilbert, Chandler, Tempe, Queen Creek, and surrounding neighborhoods.',
  },
]
...
export default function EastValleyWindowWashingPage() {
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'East Valley window cleaning', url: 'https://arizonawindowwashingpros.com/locations/east-valley-window-washing' },
  ])
    ...
    <>
      ...
      <section className="section-padding">
        <div className="container-custom max-w-4xl">
          <div className="prose prose-lg max-w-none">
            ...
            <h2 className="text-2xl font-bold mb-4">Why Choose Us for East Valley window cleaning?</h2>
            <p className="text-gray-700 mb-4">
              East Valley&apos;s unique climate presents specific challenges for window cleaning, from intense sun that creates hard water spots to dust storms that leave windows dirty. Our team has extensive experience working throughout East Valley and knows exactly how to handle these conditions.
            </p>
            <p className="text-gray-700 mb-8">
              We use professional-grade equipment and eco-friendly cleaning solutions to ensure your East Valley home&apos;s windows are spotless and streak-free. Our local team understands East Valley neighborhoods and works efficiently to minimize disruption to your day.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="section-padding bg-white">
        <div className="container-custom max-w-5xl">
          <div className="content-section">
            <h2 className="text-2xl font-bold mb-4">Pricing Guidance for East Valley window cleaning</h2>
            <p className="text-gray-700 mb-4">
              window cleaning prices in East Valley typically range from:
            </p>
            <ul className="list-disc list-inside space-y-2 text-gray-700 mb-8">
      ...
      <section id="contact-form" className="section-padding bg-white">
        <div className="container-custom max-w-2xl">
          <ContactForm defaultCity="East Valley" />
        </div>
      </section>
            ...
            <div className="space-y-6 text-gray-700 leading-relaxed">
              ...
              <div className="bg-gray-50 rounded-xl p-6 border-l-4 border-blue-600 my-8">
                <p className="text-base md:text-lg font-semibold text-gray-900 italic">
                  This is not basic bucket cleaning. This is precision water purification engineered for high end residential properties in East Valley.
                </p>
              </div>
