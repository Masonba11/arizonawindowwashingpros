...
export const metadata = generateMetadata({
  ...
  description: 'Professional outdoor and indoor window cleaning services in East Valley, Arizona. Expert window cleaning and screen cleaning. Starting at $150 for 1-story homes. Free quotes available.',
  path: '/locations/east-valley-window-washing',
})

const faqs = [
  {
    question: 'How much does outdoor window cleaning cost in East Valley?',
  ...
  {
    question: 'Do you clean both indoor and outdoor windows in East Valley?',
    answer: 'Yes, we offer both indoor and outdoor window cleaning services in East Valley. You can choose one or both depending on your needs.',
  },
  {
