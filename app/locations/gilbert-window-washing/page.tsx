...
export default function GilbertWindowWashingPage() {
  ...
  return (
    <>
      ...
      <LocationWhyChooseUs
        idPrefix="gilbert-window-washing"
        sectionHeading="Why Choose Us for Gilbert window cleaning?"
        cityPossessive="Gilbert's"
        cityName="Gilbert"
        experiencePhrase="working in Gilbert"
        neighborhoodsSnippet="downtown Gilbert, Val Vista, Higley, or newer master-planned communities"
      />
