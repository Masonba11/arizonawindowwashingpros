...
const faqs = [
  {
    question: 'How much does outdoor window cleaning cost in Tempe?',
  ...
  {
    question: 'Do you clean both indoor and outdoor windows in Tempe?',
    answer: 'Yes, we offer both indoor and outdoor window cleaning services in Tempe. You can choose one or both depending on your needs.',
  },
  {
...
export default function TempeWindowWashingPage() {
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'Tempe window cleaning', url: 'https://arizonawindowwashingpros.com/locations/tempe-window-washing' },
  ])
  ...
  return (
    <>
      ...
      <LocationWhyChooseUs
        idPrefix="tempe-window-washing"
        sectionHeading="Why Choose Us for Tempe window cleaning?"
        cityPossessive="Tempe's"
        cityName="Tempe"
        experiencePhrase="working in Tempe"
        neighborhoodsSnippet="downtown Tempe, South Tempe, or newer master-planned communities"
      />
        ...
        <div className="container-custom max-w-6xl">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Why Our Deionized Water System Matters in Tempe
            </h2>
            ...
            <div className="order-1 md:order-2 bg-white rounded-2xl p-8 md:p-12 border-2 border-blue-100 shadow-xl">
              ...
              <div className="bg-gray-50 rounded-xl p-6 border-l-4 border-blue-600 my-8">
                <p className="text-base md:text-lg font-semibold text-gray-900 italic">
                  This is not basic bucket cleaning. This is precision water purification engineered for high end residential properties in Tempe.
                </p>
              </div>
        ...
        <div className="container-custom max-w-5xl">
          <div className="content-section">
            <p className="text-xl md:text-2xl text-gray-700 mb-8 leading-relaxed text-center">
              Looking for professional Tempe window cleaning services? You&apos;ve come to the right place. We specialize in providing top-quality window cleaning and screen cleaning for Tempe homeowners and businesses.
            </p>
          </div>

          {/* What's Included */}
          <div className="content-section">
            <h2 className="text-3xl font-bold mb-6 text-gray-900">What&apos;s Included in Our Tempe window cleaning Service</h2>
        ...
        <div className="container-custom max-w-5xl">
          <div className="content-section">
            <div className="text-center mb-10">
              <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-900">Professional window cleaning in Tempe, Arizona</h2>
              <div className="w-24 h-1 bg-gradient-to-r from-primary-500 to-primary-600 mx-auto rounded-full"></div>
            </div>
            <div className="space-y-6">
              <p className="text-xl text-gray-700 leading-relaxed">
                Tempe homeowners know that maintaining clean windows in Arizona&apos;s desert climate requires specialized expertise. With intense sun, frequent dust storms, and hard water challenges, Tempe windows need professional care to stay crystal clear. Arizona window cleaning Pros brings years of local experience to every Tempe home we serve.
              </p>
      ...
      <section className="section-padding bg-gray-50">
        <div className="container-custom max-w-4xl">
          <h2 className="text-2xl font-bold mb-4">Pricing Guidance for Tempe window cleaning</h2>
          <p className="text-gray-700 mb-4">
            window cleaning prices in Tempe typically range from:
          </p>
