...
export const metadata = generateMetadata({
  ...
  description: 'Professional outdoor and indoor window cleaning services in Chandler, Arizona. Expert window cleaning and screen cleaning. Starting at $150 for 1-story homes. Free quotes available.',
