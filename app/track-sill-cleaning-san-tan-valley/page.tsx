...
export const metadata: Metadata = {
  title: 'Track & Sill Cleaning in San Tan Valley, AZ | $100 OFF | Arizona Window Washing Pros',
  description: 'Professional track and sill cleaning in San Tan Valley, Arizona. $100 off first service. Licensed, insured, streak-free guarantee. Call (480) 737-0850 for free estimate.',
  alternates: {
