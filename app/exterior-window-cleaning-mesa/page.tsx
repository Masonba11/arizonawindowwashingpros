...
export const metadata: Metadata = {
  ...
  description: 'Professional exterior window cleaning in Mesa, Arizona. $100 off first service. Licensed, insured, streak-free guarantee. Call (928) 235-5934 for free estimate.',
  alternates: {
