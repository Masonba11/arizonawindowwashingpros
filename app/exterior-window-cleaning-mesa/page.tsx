...
export const metadata: Metadata = {
  title: 'Exterior Window Cleaning in Mesa, AZ | $100 OFF | Arizona Window Washing Pros',
  description: 'Professional exterior window cleaning in Mesa, Arizona. $100 off first service. Licensed, insured, streak-free guarantee. Call (480) 737-0850 for free estimate.',
  alternates: {
