...
function ConversionOptimizedHeroSection({
  service,
  city,
  nearbyAreas,
  handleCallClick,
        ...
        <div className="hero-bg-wrapper z-0">
          <div className="hero-bg-zoom">
            ...
            <video
              ...
              playsInline
              preload="none"
              className="absolute inset-0 w-full h-full hero-bg-image transition-opacity duration-500"
        ...
        <div className="container mx-auto px-4 max-w-7xl relative z-10 pt-0 md:pt-4 w-full">
          ...
          <div className="flex items-center justify-between mb-4 md:mb-6 gap-4">
            ...
            <div className="flex-shrink-0">
              <img
                ...
                style={{
                  filter:
                    "drop-shadow(0 0 10px rgba(255, 255, 255, 0.8)) drop-shadow(0 0 20px rgba(255, 255, 255, 0.6)) drop-shadow(0 0 30px rgba(255, 255, 255, 0.4)) drop-shadow(2px 2px 8px rgba(0,0,0,0.8))",
                }}
              />
            </div>
            {/* 20% OFF Badge */}
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-start">
            ...
            <div className="space-y-6">
              ...
              <div>
                <h1
                  className="text-3xl md:text-5xl lg:text-6xl font-bold text-white mb-2 md:mb-3 drop-shadow-2xl"
                ...
                <p
                  className="text-lg md:text-xl text-white mb-1 md:mb-2 drop-shadow-lg"
                  style={{ textShadow: "1px 1px 4px rgba(0,0,0,0.8)" }}
                >
                ...
                <div className="flex flex-wrap gap-3 md:gap-4 mb-2 md:mb-3">
                  <div className="flex items-center gap-2 text-white">
                    <svg
                      className="w-5 h-5 md:w-6 md:h-6 text-green-400 flex-shrink-0"
                      fill="currentColor"
                      viewBox="0 0 20 20"
                    >
                      <path
                    ...
                    <span
                      className="font-semibold text-sm md:text-base drop-shadow-lg"
                ...
                <p
                  className="text-base md:text-lg text-white/95 drop-shadow-lg"
                  style={{ textShadow: "1px 1px 3px rgba(0,0,0,0.8)" }}
                >
              ...
              {/* Services Line */}
              <p
                className="text-base md:text-lg text-white mb-4 drop-shadow-lg text-center md:text-left"
                style={{ textShadow: "1px 1px 3px rgba(0,0,0,0.8)" }}
              >
                Interior cleaning, Exterior cleaning, Tracks & sills, Screens we
                handle it all.
              </p>
          ...
          <div className="bg-gradient-to-br from-blue-50 to-white rounded-2xl p-8 md:p-12 border-2 border-blue-100 shadow-xl">
            <div className="space-y-6 text-gray-700 leading-relaxed">
              <p className="text-base md:text-lg">
                In Arizona the water is extremely mineral heavy. That means even
                after a traditional cleaning, microscopic calcium and mineral
                deposits can remain on the glass. Once the water dries, those
                deposits turn into visible streaks and hard water marks.
              </p>
              ...
              <p className="text-base md:text-lg">
                Arizona Window Washing Pros uses a professional grade Deionized
                water purification system. This is advanced filtration
                technology designed to remove dissolved minerals and impurities
                from the water before it ever touches your windows.
              </p>
              ...
              <p className="text-base md:text-lg">
                What remains is ultra purified water that dries crystal clear.
                No streaks. No spotting. No residue left behind.
              </p>

              <p className="text-base md:text-lg">
                Because the water contains zero minerals, it evaporates cleanly
                and helps reduce future buildup. Your glass is left with a
                refined, polished appearance that stays cleaner longer.
              </p>
              ...
              <div className="bg-gray-50 rounded-xl p-6 border-l-4 border-blue-600 my-8">
                <p className="text-base md:text-lg font-semibold text-gray-900 italic">
                  This is not basic bucket cleaning. This is precision water
                  purification engineered for high end residential properties in{" "}
                  {city}.
                </p>
              </div>

              <p className="text-base md:text-lg font-semibold text-gray-900 text-center">
                For homeowners who expect clarity, longevity, and a higher
                standard of care, this is the difference.
              </p>

              <p className="text-base md:text-lg font-semibold text-gray-900 text-center mt-6">
                This is more than just cleaning your windows, it is also our
                mission to protect your asset.
              </p>
            </div>
          </div>
        </div>
...
export default function ServiceCityLanding({
  ...
  nearbyAreas,
  faqs,
}: ServiceCityLandingProps) {
  const handleCallClick = () => {
    trackCallClick(
      `service_city_${serviceSlug}_${city.toLowerCase().replace(" ", "_")}`,
    );
