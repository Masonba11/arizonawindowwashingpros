...
export function generateLocalBusinessSchema() {
  ...
  return {
    ...
    description: 'Professional exterior and interior window cleaning services in Pinetop, Lakeside, Show Low, and Snowflake, Arizona. Expert window cleaning and screen cleaning.',
