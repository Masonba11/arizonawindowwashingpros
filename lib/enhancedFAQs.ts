...
export function generateServiceFAQs(serviceName: string, city?: string): FAQ[] {
  ...
  return [
    ...
    },
    {
      ...
      answer: 'Scheduling is easy! Call us at (928) 235-5934 or fill out our free quote form. We typically have same-week availability and will work with your schedule to find a convenient time.',
    },
    {
